...
let PDFParser = (function () {
	...
	let _startParsingPDF = function(buffer, password = '') {
		this.data = {};
		...
		this.PDFJS.parsePDFData(buffer || _binBuffer[this.pdfFilePath], password);
	};
	...
	PdfParser.prototype.loadPDF = function(pdfFilePath, password = '', verbosity) {
		...
		this.fq.push({path: pdfFilePath, password : password}, _processPDFContent.bind(this));
	};
	...
	PdfParser.prototype.parseBuffer = function(pdfBuffer, password = '') {
		_startParsingPDF.call(this, pdfBuffer, password);
	};
